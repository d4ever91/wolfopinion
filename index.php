...
<body>
    ...
    <header>
        <div id="logo_home">
            <h1><a href="/" title="Quote">Wolfopinion</a></h1>
        </div>
    ...
    <div class="intro_txt animated fadeInUp">
        <h2>Your Opinion  matters and we want it to be heard!!</h2>
        <p>We connect you with top-tier researchers who are interested in your opinion. Join Wolf Opinion to let the world know what you want to say.</p>
      <li class="btn-started" style="border-right: none;
    background: #EDAB2A;     margin-top: 20px; list-style: none;   font-size: 20px;
    border-radius: 5px;width: 120px;"><a style="color: #fff;
    line-height: 1;
    padding: 10px 15px;    
    display: inline-block;" href="signup.php">Get Started</a></li>
    </div><!-- /intro_txt -->
	...
	</video><!-- /video --><div class="video_fallback"></div>
    ...
    <div id="additional_links">
        <ul>
            <li>Copyright © 2021 Wolf Opinion  | All rights reserved</li>
        </ul>
    </div><!-- /add links -->
